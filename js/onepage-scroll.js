    ...
    e.fn.onepage_scroll = function (n) {
        ...
        e.fn.transformPage = function (t, n, r) {
            ...
            if (t.direction == "horizontal") {
                var s = i.width() / 100 * n;
                e(this).animate({left: s + "px"}, t.animationTime, t.easing);
            } else {
                var s = i.height() / 100 * n;
                e(this).animate({top: s + "px"}, t.animationTime, t.easing, function () {
                    if (typeof t.afterMove == "function")
                        t.afterMove(r);
                });
            }
        };
        e.fn.loadPage = function (t, n, r) {
            if (t.direction == "horizontal") {
                var s = i.width() / 100 * n;
                e(this).css({left: s + "px"});
            } else {
                var s = i.height() / 100 * n;
                e(this).css({top: s + "px"});
                if (typeof t.afterMove == "function")
        ...
        e.each(s, function (t) {
            ...
            if (r.direction == "horizontal")
                ...
                topPos = topPos + 100;
            if (r.pagination == true) {
                paginationList += "<li><a data-index='" + (t + 1) + "'></a></li>"
            }
        });
        i.swipeEvents().bind("swipeDown", function (t) {
            if (!e("body").hasClass("disabled-onepage-scroll"))
